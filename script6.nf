 ...
 * and fastqc processes. Combine different output in a single report
 */
process multiqc {
    publishDir params.outdir, mode:'copy'

    input:
    // all the files collected from quant_ch mixed with fastqc channel
    // collect take all the data and use into one channel
    ...
    script:
    """
    # multiqc works in a current directory
    multiqc .
    """
}
